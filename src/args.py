...
modified based on https://github.com/mlpc-ucsd/LETR/blob/master/src/args.py
"""
...
def get_args_parser():
    ...
    parser.add_argument('--bins_bb_segment', action='store_true', default=False)
    parser.add_argument('--bins_path', type=str, default=None)
    parser.add_argument('--bins_lines_annotation_dir', type=str, default=None)
